    ...
    >
      <div className="container">
        <div className="about">
          ...
          <p>
            <span>Email:</span>nandisubhajit20022gmail.com
          </p>
          <p>
            <span>Phone:</span>8927264906
          </p>
        </div>
      ...
      <div className="container">
        ...
        <div className="links">
          <Link
            to={"https://www.instagram.com/nandi_subhajit_/"}
            target="_blank"
          >
            <AiFillInstagram />
          </Link>
          <Link to={"https://github.com/SUBHAJITNANDI2002"} target="_blank">
            <FaGitSquare />
          </Link>
          <Link
            to={"/"}
          ...
          <Link
            to={"https://www.linkedin.com/in/subhajit-nandi-a60700211/"}
            target="_blank"
          >
            <AiFillLinkedin />
          </Link>
